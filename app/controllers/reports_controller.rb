class ReportsController < ApplicationController
  ...
  def find_total_volume
    ...
    Genre.find_each do |genre_elem|
      ...
      genre_elem.subgenres.each do |subgenre_elem|
        _subgenre_to_volume[genre_elem.name][subgenre_elem.name] = subgenre_elem.count_books_in_subgenre
      end
    end
  ...
  def find_highest_rating
    ...
    Book.find_each do |book|
      ...
      highest_rating[book.name] = avg_review
    end
  ...
  def find_best_seller_by_volume
    ...
    Book.find_each do |book|
      best_seller_by_volume[book.name] += book.total_volume_sold
    end
